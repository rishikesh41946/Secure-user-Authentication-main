...
import { fogotPasswordSchema, resetPasswordSchema, } from "../validation/passwordValidation.js";
...
class Password {
    async forgotPassword(req, res) {
        try {
            ...
            return res.json({
                message: "Password reset sent link successfully please cheak your email",
            });
        }
        catch (err) {
